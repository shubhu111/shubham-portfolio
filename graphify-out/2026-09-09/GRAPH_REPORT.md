# Graph Report - shubham-portfolio  (2026-09-06)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 201 nodes · 213 edges · 26 communities (12 shown, 10 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 721 input · 74 output
...
5. `scripts` - 5 edges
6. `InteractiveBackground()` - 4 edges
7. `generate_chat_stream()` - 4 edges
8. `ProjectsClient()` - 4 edges
9. `dataset` - 4 edges
...
### Community 0 - "Frontend Core Dependencies"
Cohesion: 0.06
Nodes (33): framer-motion, @google/generative-ai, lucide-react, material-icons, next, next-sanity, @next/third-parties, dependencies (+25 more)
...
## Knowledge Gaps
- **85 isolated node(s):** `framer-motion`, `@google/generative-ai`, `lucide-react`, `material-icons`, `next` (+80 more)
...
- **Why does `dependencies` connect `Frontend Core Dependencies` to `package.json`?**
...
- **What connects `framer-motion`, `@google/generative-ai`, `lucide-react` to the rest of the system?**
